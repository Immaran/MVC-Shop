...
namespace MVCProject.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CategoryID,Name,Visibility,ParentID")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CategoryID,Name,Visibility,ParentID")] Category category)
        {
            if (ModelState.IsValid)
            {
